...
$q = "select * from articles where 1 order by created_at desc";
$r = $conn->query($q);
...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3">
                ...
                <ol class="list-group">
        <?php
  $c = "select * from categories where 1";
  $cr = $conn->query($c);
  ...
  <li class="list-group-item d-flex justify-content-between align-items-start">
    <div class="ms-2 me-auto">
      <div class="fw-bold"><i class="bi bi-<?= $row['icon']?>"></i> <?= $row['name'] ?></div>      
    </div>
      ...
      <div class="col-md-9">
        ...
        ?>
          <div class="card mb-3 col-md-4">
            <a href="details.php?id=<?= $row['id'] ?>"><img src="assets/aimages/<?= $row['images'] ?>" class="card-img-top" alt="<?= $row['title'] ?>">
              <div class="card-body">
                <h5 class="card-title"><?= $row['title'] ?></h5>
                <!-- <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p> -->
                <p class="card-text">
                  <small class="text-muted">Last updated <?= $row['created_at']; ?></small></p>
